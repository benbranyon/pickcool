...
accordance with our website. What personal information do we collect 
from the people that visit our blog, website or app? When ordering or 
registering on our site, as appropriate, you may be asked to enter your 
name, email address, mailing address, phone number  or other details to 
help you with your experience.  When do we collect information?  We 
...
<ul>
<li>
<strong>How do we use your information?</strong>  We may use the information we collect 
...
<li>
<strong>How do we protect visitor information?</strong>  Our website is scanned on a 
...
you supply is encrypted via Secure Socket Layer (SSL) technology.   We 
...
information.  For your convenience we may store your credit card 
information kept for more than 60 days in order to expedite future 
orders, and to automate the billing process.
</li>
<li>
<strong>Do we use 'cookies'?</strong>  Yes. Cookies are small files that a site or its 
...
correct way to modify your cookies.
         If users disable cookies in their browser: If you disable cookies off, 
some features will be disabled It will turn off some of the features 
...
<ul>
<li>
    <strong>Do we disclose the information we collect to Third Parties?</strong>  We 
...
chat account etc., screen name or user names, phone number, cookie 
number, ip address device serial #, unique device identifier personally 
...
cookie enables it to serve ads to our users based on their visit to our 
...
<li>
         ...
         <strong>We have/ or plan to implement the following:</strong> 
         <ul>
         <li>Remarketing with Google AdSense</li>
         <li>Google Display Network Impression Reporting:</li>
          <ul><li>Demographics and Interests Reporting</li>
...
shared, and to comply with this policy.<br/> -  See more at: 
http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf
<br />
         <strong>According to CalOPPA we agree to the following:</strong>
         <ul>
         <li>Users can visit our site anonymously.</li>
         <li>Once this privacy policy is created, we will add a link to it on our 
home page, or as a minimum on the first significant page after entering 
our website.</li>
         <li>Our Privacy Policy link includes the word 'Privacy', and can be easily 
be found on the page specified above.</li>
         ...
         By logging in to their account</li>

         <li>How does our site handle do not track signals?  We don't honor do not 
track signals and do not track, plant cookies, or use advertising when a 
Do Not Track (DNT) browser mechanism is in place.</li>

         <li>Does our site allow third party behavioral tracking?  It's also 
important to note that we allow third party behavioral tracking</li>
        </ul>
</p>
<p>
...
to:
  <ul>
         <li>Send information, respond to inquiries, and/or other requests or 
questions.</li>
         <li>Market to our mailing list or continue to send emails to our clients 
after the original transaction has occurred</li>
</ul>
...
used.</li>
         ...
         <li>Allow users to unsubscribe by using the link at the bottom of each 
email</li>
</ul>
</p>
<p>
